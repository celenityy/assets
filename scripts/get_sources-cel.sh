...
function update_sha512sum() {
  ...
  if [[ "${old_sha512sum}" == "${PYTHON_SHA512SUM_LINUX_ARM64}" ]]; then
    ...
    "${CEL_ASSETS_SED}" -i -e "s|PYTHON_SHA512SUM_LINUX_ARM64='.*'|PYTHON_SHA512SUM_LINUX_ARM64='"${new_sha512sum}"'|g" "${CEL_ASSETS_VERSIONS}"
    ...
    "${CEL_ASSETS_SED}" -i -e "s|PYTHON_SHA512SUM_LINUX_X86_64='.*'|PYTHON_SHA512SUM_LINUX_X86_64='"${new_sha512sum}"'|g" "${CEL_ASSETS_VERSIONS}"
    ...
    "${CEL_ASSETS_SED}" -i -e "s|PYTHON_SHA512SUM_OSX_ARM64='.*'|PYTHON_SHA512SUM_OSX_ARM64='"${new_sha512sum}"'|g" "${CEL_ASSETS_VERSIONS}"
    ...
    "${CEL_ASSETS_SED}" -i -e "s|PYTHON_SHA512SUM_OSX_X86_64='.*'|PYTHON_SHA512SUM_OSX_X86_64='"${new_sha512sum}"'|g" "${CEL_ASSETS_VERSIONS}"
    ...
    "${CEL_ASSETS_SED}" -i -e "s|S3CMD_SHA512SUM='.*'|S3CMD_SHA512SUM='"${new_sha512sum}"'|g" "${CEL_ASSETS_VERSIONS}"
    ...
    "${CEL_ASSETS_SED}" -i -e "s|UV_SHA512SUM_LINUX_ARM64='.*'|UV_SHA512SUM_LINUX_ARM64='"${new_sha512sum}"'|g" "${CEL_ASSETS_VERSIONS}"
    ...
    "${CEL_ASSETS_SED}" -i -e "s|UV_SHA512SUM_LINUX_X86_64='.*'|UV_SHA512SUM_LINUX_X86_64='"${new_sha512sum}"'|g" "${CEL_ASSETS_VERSIONS}"
    ...
    "${CEL_ASSETS_SED}" -i -e "s|UV_SHA512SUM_OSX_ARM64='.*'|UV_SHA512SUM_OSX_ARM64='"${new_sha512sum}"'|g" "${CEL_ASSETS_VERSIONS}"
    ...
    "${CEL_ASSETS_SED}" -i -e "s|UV_SHA512SUM_OSX_X86_64='.*'|UV_SHA512SUM_OSX_X86_64='"${new_sha512sum}"'|g" "${CEL_ASSETS_VERSIONS}"
...
function get_python() {
  ...
  if [[ "${CEL_ASSETS_GET_SOURCE_CHECKSUM_UPDATE}" == 1 ]]; then
    ...
    validate_sha512sum "${PYTHON_SHA512SUM_LINUX_ARM64}" "${CEL_ASSETS_PYTHON_DIR}/${PYTHON_GIT_RELEASE}/cpython-${PYTHON_VERSION}+${PYTHON_GIT_RELEASE}-aarch64-unknown-linux-gnu-install_only_stripped.tar.gz"
    ...
    # "Validate" (Update) SHA512sum
    validate_sha512sum "${PYTHON_SHA512SUM_LINUX_X86_64}" "${CEL_ASSETS_PYTHON_DIR}/${PYTHON_GIT_RELEASE}/cpython-${PYTHON_VERSION}+${PYTHON_GIT_RELEASE}-x86_64-unknown-linux-gnu-install_only_stripped.tar.gz"
    ...
    # "Validate" (Update) SHA512sum
    validate_sha512sum "${PYTHON_SHA512SUM_OSX_ARM64}" "${CEL_ASSETS_PYTHON_DIR}/${PYTHON_GIT_RELEASE}/cpython-${PYTHON_VERSION}+${PYTHON_GIT_RELEASE}-aarch64-apple-darwin-install_only_stripped.tar.gz"
    ...
    # "Validate" (Update) SHA512sum
    validate_sha512sum "${PYTHON_SHA512SUM_OSX_X86_64}" "${CEL_ASSETS_PYTHON_DIR}/${PYTHON_GIT_RELEASE}/cpython-${PYTHON_VERSION}+${PYTHON_GIT_RELEASE}-x86_64-apple-darwin-install_only_stripped.tar.gz"
  else
    ...
    # Validate SHA512sum
    validate_sha512sum "${PYTHON_SHA512SUM}" "${CEL_ASSETS_PYTHON_DIR}/${PYTHON_GIT_RELEASE}/cpython-${PYTHON_VERSION}+${PYTHON_GIT_RELEASE}-${PYTHON_ARCH}-${PYTHON_PLATFORM}-install_only_stripped.tar.gz"
...
function get_uv() {
  ...
  if [[ "${CEL_ASSETS_GET_SOURCE_CHECKSUM_UPDATE}" != 1 ]]; then
    ...
    if [[ -d "${CEL_ASSETS_PYENV_DIR}" ]]; then
      echo_red_text "The uv environment is already set-up at ${CEL_ASSETS_PYENV_DIR}"
  ...
  if [[ "${CEL_ASSETS_GET_SOURCE_CHECKSUM_UPDATE}" == 1 ]]; then
    ...
    download_and_extract 'uv' "https://github.com/astral-sh/uv/releases/download/${UV_VERSION}/uv-aarch64-unknown-linux-gnu.tar.gz" "${CEL_ASSETS_UV_DIR}" "${UV_SHA512SUM_LINUX_ARM64}"

    echo_red_text 'Downloading uv (Linux - x86_64)...'
    download_and_extract 'uv' "https://github.com/astral-sh/uv/releases/download/${UV_VERSION}/uv-x86_64-unknown-linux-gnu.tar.gz" "${CEL_ASSETS_UV_DIR}" "${UV_SHA512SUM_LINUX_X86_64}"

    echo_red_text 'Downloading uv (OS X - ARM64)...'
    download_and_extract 'uv' "https://github.com/astral-sh/uv/releases/download/${UV_VERSION}/uv-aarch64-apple-darwin.tar.gz" "${CEL_ASSETS_UV_DIR}" "${UV_SHA512SUM_OSX_ARM64}"

    echo_red_text 'Downloading uv (OS X - x86_64)...'
    download_and_extract 'uv' "https://github.com/astral-sh/uv/releases/download/${UV_VERSION}/uv-x86_64-apple-darwin.tar.gz" "${CEL_ASSETS_UV_DIR}" "${UV_SHA512SUM_OSX_X86_64}"
  else
    echo_red_text 'Downloading uv...'
    download_and_extract 'uv' "https://github.com/astral-sh/uv/releases/download/${UV_VERSION}/uv-${UV_ARCH}-${UV_PLATFORM}.tar.gz" "${CEL_ASSETS_UV_DIR}" "${UV_SHA512SUM}"

    echo_red_text 'Installing Python...'
    "${CEL_ASSETS_UV}" python install "${PYTHON_VERSION}"

    echo_red_text 'Creating uv environment...'
    "${CEL_ASSETS_UV}" venv "${CEL_ASSETS_PYENV_DIR}"
    echo_green_text "SUCCESS: Set-up uv environment at ${CEL_ASSETS_PYENV_DIR}"
  fi
}
