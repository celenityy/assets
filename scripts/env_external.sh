# celenity assets external environment variables

## This is used for converting celenity assets-specific environment variables to ones used in external projects.
...
## Use the celenity assets equivalent variables (at `env_common.sh`) instead.
...
## Cache directory
readonly UV_CACHE_DIR="${CEL_ASSETS_UV_LOCAL}/cache"
export UV_CACHE_DIR
...
readonly UV_PYTHON_BIN_DIR="${CEL_ASSETS_UV_LOCAL}/bin"
...
## Location
readonly UV_INSTALL_DIR="${CEL_ASSETS_UV_DIR}"
...
readonly UV_UNMANAGED_INSTALL="${CEL_ASSETS_UV_DIR}"
...
## Python
readonly UV_PYTHON_CACHE_DIR="${CEL_ASSETS_UV_LOCAL}/python-cache"
readonly UV_PYTHON_INSTALL_MIRROR="file://${CEL_ASSETS_PYTHON_DIR}"
readonly UV_PYTHON_INSTALL_DIR="${CEL_ASSETS_UV_LOCAL}/python"
export UV_PYTHON_CACHE_DIR
export UV_PYTHON_INSTALL_MIRROR
export UV_PYTHON_INSTALL_DIR

## Python environment
readonly UV_PROJECT_ENVIRONMENT="${CEL_ASSETS_PYENV_DIR}"
readonly VIRTUAL_ENV="${CEL_ASSETS_PYENV_DIR}"
export UV_PROJECT_ENVIRONMENT
export VIRTUAL_ENV

## Tools directory
readonly UV_TOOL_BIN_DIR="${CEL_ASSETS_UV_LOCAL}/tools/bin"
readonly UV_TOOL_DIR="${CEL_ASSETS_UV_LOCAL}/tools"
